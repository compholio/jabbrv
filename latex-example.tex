...
Test 
\cite{%
    ref:TestNoPeriod,ref:TestDiacritic,ref:Test,ref:TestJabbrv,ref:TestPeriod,%
    ref:TestPeriodTwoWords,ref:TestPeriodRefInf,ref:TestPeriodInf,ref:TestMyAbbrvOneWord,%
    ref:TestMyAbbrvTwoWords,ref:TestPeriodInfPeriod,ref:CmdTest,ref:AbbrvTest,ref:SymbolTest%
}.
